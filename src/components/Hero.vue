...
<template>
  <section
    class="bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 pt-16 pb-20 md:pt-24 md:pb-28 border-b border-neutral-200 dark:border-neutral-700/50"
  >
