...
<template>
  <section id="tentang" class="py-20 lg:py-28 bg-neutral-50 dark:bg-neutral-800/40 text-neutral-900 dark:text-neutral-100 border-b border-neutral-200 dark:border-neutral-700/50">
    <div class="max-w-6xl mx-auto px-6 sm:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-16">
        ...
        <div class="lg:col-span-7">
          <p class="text-neutral-700 dark:text-neutral-300 text-base sm:text-lg leading-relaxed">
            Kurikulum PPLG dirancang selaras dengan kebutuhan industri perangkat lunak saat ini. Siswa tidak hanya mempelajari teori algoritma di ruang kelas, tetapi juga langsung mempraktikkannya melalui pembuatan projek nyata di laboratorium komputer.
          </p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-16">
        ...
        <div class="lg:col-span-6 bg-white dark:bg-neutral-800 p-8 rounded-lg border border-neutral-300 dark:border-neutral-700/60 flex flex-col justify-between space-y-6">
          <div class="space-y-4">
            <div class="text-xs font-mono text-neutral-500 dark:text-neutral-400 uppercase">Tiga Pilar Konsentrasi</div>
            <h3 class="text-xl font-bold text-neutral-900 dark:text-neutral-100">Fokus Pengembangan Keahlian</h3>
            
            <div class="space-y-4 pt-2">
              <div v-for="focus in focusAreas" :key="focus.id" class="border-b border-neutral-200 dark:border-neutral-700/60 pb-4 last:border-0 last:pb-0">
                <div class="flex items-center justify-between">
                  <h4 class="font-bold text-neutral-900 dark:text-neutral-100 text-base">{{ focus.title }}</h4>
                  <span class="text-xs font-mono text-primary-700 dark:text-primary-300">{{ focus.techs.slice(0, 3).join(', ') }}</span>
                </div>
                <p class="text-xs text-neutral-600 dark:text-neutral-400 mt-1 leading-relaxed">{{ focus.description }}</p>
              </div>
            </div>
          </div>

          <div class="pt-4 border-t border-neutral-200 dark:border-neutral-700/60 text-xs font-mono text-neutral-500 dark:text-neutral-400 flex items-center justify-between">
            <span>Standar Industri Nasional</span>
            <span class="text-accent-success font-semibold">● Terakreditasi A</span>
          </div>
        </div>
