...
export const gradeStructures: GradeStructure[] = [
  // ── Kelas 10 ──
  {
    ...
    students: [
      { name: "Alsyah", igUsername: "username.example", cvSlug: "alsyah" },
      { name: "Alya Nur Fauziah", igUsername: "username.example", cvSlug: "alya" },
      { name: "Azzahra Meita Putri", igUsername: "username.example", cvSlug: "azzahra" },
      ...
      { name: "Dwi Rafi Mazdudin", igUsername: "username.example", cvSlug: "rafi" },
      ...
      { name: "Hasan", igUsername: "username.example", cvSlug: "hasan" },
      { name: "Ilham Makhrus Salam", igUsername: "username.example" },
      { name: "Krisna Apriyono", igUsername: "username.example" },
      { name: "Lulu Isnawati", igUsername: "username.example", cvSlug: "lulu" },
      ...
      { name: "Muhammad Lutpi", igUsername: "username.example", cvSlug: "lutpi" },
      { name: "Muhammad Rifan Nur Hidayah", igUsername: "username.example" },
      { name: "Nihayatul Karimah", igUsername: "username.example", cvSlug: "niha" },
      { name: "Noval Fazri", igUsername: "username.example", cvSlug: "noval" },
      { name: "Nurmala Ayu Komalasari", igUsername: "username.example", cvSlug: "mala" },
      { name: "Retno Ayu Anjani", igUsername: "username.example", cvSlug: "retno" },
      { name: "Reva Alviani", igUsername: "username.example", cvSlug: "reva" },
      { name: "Ridho Firmansyah", igUsername: "username.example" },
      { name: "Rido Maulana", igUsername: "username.example" },
      { name: "Sahla Tri Nurrani", igUsername: "username.example", cvSlug: "sahla" },
      { name: "Sartono Tegar Priyatna", igUsername: "username.example" },
      { name: "Shinta Ramadhani", igUsername: "username.example", cvSlug: "shinta" },
      { name: "Vebyola Oktaviani", igUsername: "username.example", cvSlug: "vebyola" },
      { name: "Wildan Aziz Mubakkir", igUsername: "username.example" },
      { name: "Zazkya Fadillah", igUsername: "username.example", cvSlug: "zazkya" },
  ...
  // ── Kelas 11 ──
  {
    ...
    students: [
      { name: "Ahmad Yusuf Firdaus", igUsername: "_ahmd.ysf_", cvSlug: "yusuf" },
      { name: "Alsyah", igUsername: "username.example", cvSlug: "alsyah" },
      { name: "Alya Nur Fauziah", igUsername: "username.example", cvSlug: "alya" },
      { name: "Azzahra Meita Putri", igUsername: "username.example", cvSlug: "azzahra" },
      { name: "Dendi Soemantri", igUsername: "username.example" },
  ...
  // ── Kelas 12 ──
  {
    ...
    students: [
      ...
      { name: "Mitha Salsabila", igUsername: "username.example" },
      { name: "Muhamad Saiful Anwar", igUsername: "username.example" },
      { name: "Muhamad Lutpi", igUsername: "username.example", cvSlug: "lutpi" },
      { name: "Muhammad Rifan Nur Hidayah", igUsername: "username.example" },
      { name: "Nihayatul Karimah", igUsername: "username.example", cvSlug: "niha" },
      { name: "Noval Fazri", igUsername: "username.example", cvSlug: "noval" },
      { name: "Nurmala Ayu Komalasari", igUsername: "username.example", cvSlug: "mala" },
